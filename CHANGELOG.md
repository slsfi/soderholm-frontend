...
- Merge release [`v1.5.4`](https://github.com/slsfi/digital-edition-frontend-ng/releases/tag/1.5.3) from upstream, original repository into `production` branch. ([f643a7e](https://github.com/slsfi/soderholm-frontend/commit/f643a7e04476f789a5a294a967d305c0f5e3ec3c))
